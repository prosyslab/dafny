...
public class SimplifyOptionBag {
  ...
  public static readonly Option<bool> ExplicitSetComprehension = new("--explicit-set-comprehension", "Explicitly add parentheses for set comprehension.") { };
  ...
  static SimplifyOptionBag() {
    ...
    OptionRegistry.RegisterOption(ExplicitSetComprehension, OptionScope.Cli);
