...
namespace Microsoft.Dafny {
  ...
  public record SimplifyPrintFlags(bool UseOriginalDafnyNames = false);

  public partial class SimplifyPrinter {
    private DafnyOptions options;
    private const int AtAttributesOnSameLineIndent = -1;
    static SimplifyPrinter() {
...
NoGhost - disable printing of functions, ghost methods, and proof
    ...
    private readonly SimplifyPrintFlags printFlags;
    ...
    public SimplifyPrinter(TextWriter wr, DafnyOptions options, PrintModes printMode = PrintModes.Everything, [CanBeNull] SimplifyPrintFlags printFlags = null) {
      Contract.Requires(wr != null);
      this.wr = wr;
      this.options = options;
      this.printMode = printMode;
      this.printFlags = printFlags ?? new SimplifyPrintFlags();
    }

    public static string ExprToString(DafnyOptions options, Expression expr, [CanBeNull] SimplifyPrintFlags printFlags = null) {
      Contract.Requires(expr != null);
      using var wr = new StringWriter();
      var pr = new SimplifyPrinter(wr, options, printFlags: printFlags);
      pr.PrintExpression(expr, false);
      return wr.ToString();
    }

    public static string ForallExprRangeToString(DafnyOptions options, ForallExpr expr,
      [CanBeNull] SimplifyPrintFlags printFlags = null) {
      using var wr = new StringWriter();
      var pr = new SimplifyPrinter(wr, options, printFlags: printFlags);
    ...
    public static string ExprListToString(DafnyOptions options, List<Expression> expressions, [CanBeNull] SimplifyPrintFlags printFlags = null) {
    ...
    public static string GuardToString(DafnyOptions options, bool isBindingGuard, Expression expr) {
      ...
      using (var wr = new System.IO.StringWriter()) {
        var pr = new SimplifyPrinter(wr, options);
